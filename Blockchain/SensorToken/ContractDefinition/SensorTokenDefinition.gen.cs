...
namespace IoTParking.Blockchain.SensorToken.ContractDefinition
{


    public partial class SensorTokenDeployment : SensorTokenDeploymentBase
    {
        public SensorTokenDeployment() : base(BYTECODE) { }
        public SensorTokenDeployment(string byteCode) : base(byteCode) { }
    }

    public class SensorTokenDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public SensorTokenDeploymentBase() : base(BYTECODE) { }
        public SensorTokenDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class RewardSensorFunction : RewardSensorFunctionBase { }

    [Function("rewardSensor")]
    public class RewardSensorFunctionBase : FunctionMessage
    {
    ...
    public partial class SensorRewardedEventDTO : SensorRewardedEventDTOBase { }

    [Event("SensorRewarded")]
    public class SensorRewardedEventDTOBase : IEventDTO
    {
        [Parameter("address", "sensorWallet", 1, true )]
        public virtual string SensorWallet { get; set; }
